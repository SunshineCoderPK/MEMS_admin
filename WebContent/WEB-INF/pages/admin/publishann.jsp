...
<div id="tab1" class="tabson">
    ...
    <ul class="forminfo">
    <li><label>公告标题<b>*</b></label><input name="annTitle" lay-verify="required"  id="annTitle" type="text" class="dfinput" style="width:518px;"/></li>
...
$(function () {
   ...
   form.on('submit(formDemo)', function(data) {
	   $.post('${pageContext.request.contextPath}/annocementAction_publishAnn.action',{annTitle:$("#annTitle").val(),annContent:layedit.getContent(index)},function(res){
		     if(res=="failed"){
		    	 layer.msg("添加失败");
		    	 clearall();
	    		 }

	...
	<form action="" method="post" class=" layui-form form form-horizontal" id="form-member-add">
	    <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9" style="width: 300px">
				<input type="text" class="input-text" name="hospId" id="hospital_hospId" >
			</div>
...
$(function(){
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			 $(form).ajaxSubmit({
	                dataType:"text",
	                url:"${pageContext.request.contextPath}/hospitalAction_addhop.action",
	                success:function( jsondata ){
	                	if(jsondata=="failed"){
	                		var index1=layer.alert('医院添加失败', {

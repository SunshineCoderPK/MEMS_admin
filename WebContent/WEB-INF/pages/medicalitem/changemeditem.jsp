...
<article class="page-container">
     <input type="hidden" value="${medicalitem.medicalNum} " id="medid"/>
...
$(function(){
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			 $(form).ajaxSubmit({
	                dataType:"text",
	                url:"${pageContext.request.contextPath}/medicalItemAction_changemedicalitem.action?medicalNum="+$("#medid").val(),

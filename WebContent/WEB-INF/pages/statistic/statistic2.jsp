...
<body>
 <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">按医院类型统计</strong> / <small>Statistic by hosptype</small>
...
/*         {
            ...
            roseType : 'area',
            data:[
            	{value:35, name:'在职教职工35'},
                {value:13, name:'退役教职工13'},
                {value:50, name:'学生50'},
            ]
        } */
    ]
...
$("#year").combobox({
       ...
       onChange:function(){  
           ...
           $.ajax({
               ...
               url : "${pageContext.request.contextPath}/expenseAction_statistic2.action",    //请求发送到TestServlet处
               data : {"year":year},

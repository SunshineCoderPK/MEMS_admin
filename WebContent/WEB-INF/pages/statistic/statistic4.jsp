...
<body>
 <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">按医疗类型统计</strong> / <small>Statistic by medicaltype</small>
...
$("#year").combobox({
       ...
       onChange:function(){  
           ...
           $.ajax({
               ...
               url : "${pageContext.request.contextPath}/expenseAction_statistic4.action",    //请求发送到TestServlet处
               data : {"year":year},

...
import com.kaipan.mems.utils.ConvertUtils;
...
public abstract class BaseDaoImpl<T> extends HibernateDaoSupport implements IBaseDao<T> {
	//实体类型
		...
		public void pageQuery(PageBean pageBean) {
			...
			//总数据量----select count(*) from table
			//改变Hibernate框架发出的sql形式
			detachedCriteria.setProjection(Projections.rowCount());//select count(*) from table
			List<Long> list = ConvertUtils.convert(this.getHibernateTemplate().findByCriteria(detachedCriteria));					
